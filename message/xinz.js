...
*Runtime :* ${runtime(anu)}`
            ...
            case prefix+'donate': case prefix+'donasi':
                ...
                break
            case prefix+'test': case prefix+'tes': case prefix+'p': case prefix+'P': case prefix+'Test': 
            case prefix='Tes': case 'bot': case 'Bot':
                textImg(setting.txtBoton)
                break
            case 'p': case 'P': case 'bot': case 'Bot':
                 textImg(setting.txtHint)
                break
            case prefix+'rules':
